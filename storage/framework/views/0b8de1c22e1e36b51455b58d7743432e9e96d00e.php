    ...
    <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
      <form class="form" method="POST" action="<?php echo e(route('register')); ?>">
        ...
        <div class="card card-login card-hidden mb-3">
          ...
          <div class="card-body ">
            <p class="card-description text-center"><?php echo e(__('Isikan formulir')); ?></p>
          ...
          <div class="card-footer justify-content-center">
            <button type="submit" class="btn btn-primary btn-link btn-lg"><?php echo e(__('Create account')); ?></button>
          </div>
        </div>
      </form>
    </div>
...
<?php echo $__env->make('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'register', 'title' => __('Wall Magazine')], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>