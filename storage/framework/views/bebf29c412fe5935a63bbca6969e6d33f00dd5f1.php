...
<head>
  ...
  <title>
      <?php echo e(__('Material Dashboard by Creative Tim')); ?>
  ...
  <link href="<?php echo e(asset('material')); ?>/css/material-dashboard-rtl.css?v=1.1" rel="stylesheet" />
            ...
            <div class="col-lg-6 col-md-12">
              <div class="card card-profile">
                <div class="card-avatar">
                  <a href="#pablo">
                    <img class="img" src="<?php echo e(asset('material')); ?>/img/faces/marc.jpg" />
                  </a>
                </div>
                <div class="card-body">
